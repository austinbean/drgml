...
# scp  "/Users/austinbean/Desktop/drgml/tx_half_forest_2.R" beanaus@hsrdcsub2.pmacs.upenn.edu:/project/Lorch_project2018/bean/
...
alld = read.csv("/project/Lorch_project2018/bean/tx_d2.csv")
...
write.csv(tx99, file="/project/Lorch_project2018/bean/tx99_02.csv")
...
write.csv(tx00, file="/project/Lorch_project2018/bean/tx00_02.csv")
...
write.csv(tx01, file="/project/Lorch_project2018/bean/tx01_02.csv")
...
write.csv(tx02, file="/project/Lorch_project2018/bean/tx02_02.csv")
...
write.csv(tx03, file="/project/Lorch_project2018/bean/tx03_02.csv")

# write out subsets only
new99 <- subset(res99, select=c("pid", "res99"))
write.csv(new99, file="/project/Lorch_project2018/bean/tx99small_02.csv")

new00 <- subset(res00, select=c("pid", "res00"))
write.csv(new00, file="/project/Lorch_project2018/bean/tx00small_02.csv")

new01 <- subset(res01, select=c("pid", "res01"))
write.csv(new01, file="/project/Lorch_project2018/bean/tx01small_02.csv")

new02 <- subset(res02, select=c("pid", "res02"))
write.csv(new02, file="/project/Lorch_project2018/bean/tx02small_02.csv")

new03 <- subset(res03, select=c("pid", "res03"))
write.csv(new03, file="/project/Lorch_project2018/bean/tx03small_02.csv")
